...
// Guruhni ID orqali o'chirish funktsiyasi
// Guruhni ID orqali o'chirish funktsiyasi
function deleteGroup(groupId) {
    ...
    $.ajax({
        ...
        dataType: 'json',
        success: function (data) {
            // HTML dan o'chirilgan guruhni o'chirish (tanlangan)
            location.reload();
            console.log('Guruh muvaffaqiyatli o\'chirildi');
        },
        error: function (xhr, status, error) {
            location.reload();
            console.error('Xatolik guruhni o\'chirishda:', error);
        }
    });
}

// Click hodisasini qo'llash uchun tanlangan element
